...
## 1.2. Read the layers
norway_corine <- rast(here("data", "norway_corine_stack.tif"))
trondelag_corine <- rast(here("data", "trondelag_corine_stack.tif"))
...
terra::writeRaster(norway_corine_modified,
                   here("data", "corine_modified_classes_stack.tif"))
